...
public class GUIOpciones extends javax.swing.JFrame {
    ...
    /**
     * Creates new form GUIOpciones
     */
    public GUIOpciones() {
        initComponents();
        this.setLocationRelativeTo(null);
        ControlOpciones control = new ControlOpciones(this, panelOpciones1);
        this.panelOpciones1.listenPanel(control);
        this.panelOpciones1.setTabActiva(true);
    }

    public GUIOpciones(Boolean tabActiva, String nombre) {
        initComponents();
        this.setLocationRelativeTo(null);
        ControlOpciones control = new ControlOpciones(this, panelOpciones1);
        this.panelOpciones1.listenPanel(control);
    ...
    private void initComponents() {
        ...
        panelOpciones1 = new vista.PanelOpciones();

        setDefaultCloseOperation(javax.swing.WindowConstants.DISPOSE_ON_CLOSE);
        setResizable(false);

        panelOpciones1.setBackground(new java.awt.Color(199, 216, 227));
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(GUIOpciones.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
    ...
    private vista.PanelOpciones panelOpciones1;
